                    ...
                    <table class="table striped" style="margin: 0">
                        ...
                        <tbody id="choice_list">
                            <tr class="choice_item">
                                <td><input type="radio" id="true" name="answer" value="1"
                                           style="padding-right: 10px;" {{$quiz->answer ? 'checked' : ''}}>
                                </td>
                                <td><label for="true">True</label>
                                </td>
                                <td></td>
                            </tr>
                            <tr class="choice_item">
                                <td><input type="radio" id="false" name="answer" value="0"
                                           style="padding-right: 10px;" {{$quiz->answer ? '' : 'checked'}}>
                                </td>
                                <td><label for="false">False</label>
                                </td>
                                <td></td>
                            </tr>
                        </tbody>
